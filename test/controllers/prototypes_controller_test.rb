...
class PrototypesControllerTest < ActionController::TestCase
  ...
  test "should create prototype" do
    assert_difference('Prototype.count') do
      post :create, prototype: { date: @prototype.date, major_change: @prototype.major_change, reason: @prototype.reason, title: @prototype.title }
    end
  ...
  test "should update prototype" do
    patch :update, id: @prototype, prototype: { date: @prototype.date, major_change: @prototype.major_change, reason: @prototype.reason, title: @prototype.title }
    assert_redirected_to prototype_path(assigns(:prototype))
  end
