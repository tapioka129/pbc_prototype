...
class ExperimentsControllerTest < ActionController::TestCase
  ...
  test "should create experiment" do
    assert_difference('Experiment.count') do
      post :create, experiment: { date: @experiment.date, purpose: @experiment.purpose, summary_result: @experiment.summary_result, title: @experiment.title }
    end
  ...
  test "should update experiment" do
    patch :update, id: @experiment, experiment: { date: @experiment.date, purpose: @experiment.purpose, summary_result: @experiment.summary_result, title: @experiment.title }
    assert_redirected_to experiment_path(assigns(:experiment))
  end
